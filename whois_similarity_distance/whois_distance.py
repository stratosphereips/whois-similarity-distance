...
def __get_diff_ttl(creation_date_a, creation_date_b, expiration_date_a, expiration_date_b):
...
def __get_diff_emails_by_min_dist(emails_a=[], emails_b=[]):
...
def __get_diff_name_servers_by_min_dist(name_servers_a=[], name_servers_b=[]):
...
def __features_domains_attr(domain_name_a, registrar_a, name_a, orgs_a, zipcodes_a, creation_date_a,
    ...
    diff_ttl = round(__get_diff_ttl(creation_date_a, creation_date_b, expiration_date_a, expiration_date_b), 5)
    diff_emails = round(__get_diff_emails_by_min_dist(emails_str_a, emails_str_b), 2)
    diff_name_servers = round(__get_diff_name_servers_by_min_dist(name_servers_str_a, name_servers_str_b), 2)
...
def features_domains(whois_info_a={}, whois_info_b={}):
    ...
    return __features_domains_attr(domain_name_a, registrar_a, name_a, orgs_a, zipcode_a, creation_date_a,
